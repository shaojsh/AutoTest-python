...
def test_companyRegister():
    if runMode == 'UI':
        ...
        if jenkins:
            os.system('chmod 777 /var/lib/jenkins/workspace/AutoTest-python/Auto_Test/chromedriver')
            ...
            driver = webdriver.Chrome(
                executable_path='/var/lib/jenkins/workspace/AutoTest-python/Auto_Test/chromedriver', options=option)
        else:
