...
class path_personalInfoReg(Enum):
    ...
    btn_uplaodPicture1_css = '#root > div > div.content___17Zvm > div > div.main___1rkrS > div > div > div > div > form > div:nth-child(1) > div > div:nth-child(1) > div.ant-row.ant-form-item.undefined.undefined.ant-form-item-has-success > div > div > div > span > div > div.ant-upload-list-picture-card-container > span > div'  # 身份证已上传
    btn_uplaodPicture2_css = '#root > div > div.content___17Zvm > div > div.main___1rkrS > div > div > div > div > form > div:nth-child(1) > div > div:nth-child(2) > div.ant-row.ant-form-item.undefined.undefined.ant-form-item-has-success > div > div > div > span > div > div.ant-upload-list-picture-card-container > span > div > div'  # 身份证已上传
    btn_aut_css = '#root > div > div.content___17Zvm > div > div.main___1rkrS > div > div > div > div > button'  # 去认证按钮
    btn_aut_xpath = '//*[@id="root"]/div/div[2]/div/div[2]/div/div/div/div/button'  # 去认证按钮
    # 实名认证中路径
