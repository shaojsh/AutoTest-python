...
class path_backstage_examine(Enum):
    ...
    txt_userInfor_css = '#root > section > section > main > div > div:nth-child(2) > div.ant-tabs-bar.ant-tabs-top-bar > div > div > div > div > div:nth-child(1) > div'  # 用户基本信息
    input_examine_css = '#root > section > section > main > div > div:nth-child(5) > div.ant-tabs.ant-tabs-top.ant-tabs-line > div.ant-tabs-content.ant-tabs-content-animated.ant-tabs-top-content > div > form > div > div > div > div.ant-col.ant-col-17.ant-form-item-control-wrapper > div > span > textarea'  # 审核信息
    btn_examinePass_css = '#root > section > section > main > div > div:nth-child(5) > div.ant-btn-group > button.ant-btn.ant-btn-primary'  # 审核通过
